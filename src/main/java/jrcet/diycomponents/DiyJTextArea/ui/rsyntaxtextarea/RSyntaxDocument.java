...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.modes.AbstractMarkupTokenMaker;
import jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RDocument;
import jrcet.diycomponents.DiyJTextArea.util.DynamicIntArray;
...
public class RSyntaxDocument extends RDocument implements Iterable<Token>,
	...
	protected void fireInsertUpdate(DocumentEvent e) {
		...
		try{
			...
			BurpExtender.stdout.println(e1);
		}
