...
public class Fold implements Comparable<Fold> {
	 ...
	 * @see jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.FoldType
	 */
	 ...
	 *         the offset.
	 * @see jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.FoldManager#getDeepestFoldContaining(int)
	 */
	 ...
	 * a {@link jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.FoldParser} should not remember fold regions all on a single
	 ...
	 * {@link jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.FoldParser} implementations if they determine that a fold is all
