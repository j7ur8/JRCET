...
public final class FileTypeUtil implements SyntaxConstants {
	...
	public String guessContentType(RSyntaxTextArea textArea) {
		...
		String style = SYNTAX_STYLE_NONE;
