...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.TaskTagParser.TaskNotice;
...
public class ErrorStrip extends JPanel {
	...
	private static final ResourceBundle MSG = ResourceBundle.getBundle(
			"jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.ErrorStrip");
