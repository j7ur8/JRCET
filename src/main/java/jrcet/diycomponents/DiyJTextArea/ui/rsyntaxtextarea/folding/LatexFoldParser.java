...
public class LatexFoldParser implements FoldParser {
	...
	public List<jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.Fold> getFolds(RSyntaxTextArea textArea) {
		...
		jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.Fold currentFold = null;
					...
					if (t.is(Token.RESERVED_WORD, BEGIN)) {
						...
						if (temp!=null && temp.isLeftCurly()) {
							...
							if (temp!=null && temp.getType()==Token.RESERVED_WORD) {
								if (currentFold==null) {
									currentFold = new jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.Fold(jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.folding.FoldType.CODE, textArea, t.getOffset());
