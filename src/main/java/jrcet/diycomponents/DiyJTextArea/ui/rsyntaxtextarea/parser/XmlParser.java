...
import jrcet.diycomponents.DiyJTextArea.io.DocumentReader;
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.RSyntaxDocument;
...
public class XmlParser extends AbstractParser {
	...
	private jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.DefaultParseResult result;
	...
	public ParseResult parse(RSyntaxDocument doc, String style) {
		...
		try {
			...
			result.addNotice(new jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.DefaultParserNotice(this,
...
/*
	public static void main(String[] args) {
		...
		jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.RSyntaxTextArea textArea = new
			jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.RSyntaxTextArea(25, 40);
		...
		frame.setContentPane(new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextScrollPane(textArea));
		frame.pack();
...
*/
	...
	private final class Handler extends DefaultHandler {
		...
		private void doError(SAXParseException e, jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.ParserNotice.Level level) {
			...
			jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.DefaultParserNotice pn = new DefaultParserNotice(XmlParser.this,
		...
		public void error(SAXParseException e) {
			doError(e, jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.parser.ParserNotice.Level.ERROR);
		}
