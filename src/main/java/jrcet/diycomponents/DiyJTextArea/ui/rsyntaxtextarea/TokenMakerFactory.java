...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.modes.PlainTextTokenMaker;
...
public abstract class TokenMakerFactory {
	...
	public static synchronized TokenMakerFactory getDefaultInstance() {
		if (DEFAULT_INSTANCE==null) {
			...
			if (clazz==null) {
				clazz = "jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.DefaultTokenMakerFactory";
			}
			try {
