 ...
 */
package jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip;
...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.HtmlUtil;
...
class TipWindow extends JWindow implements ActionListener {
	...
	private jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.FocusableTip ft;
	 ...
	 */
	TipWindow(Window owner, jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.FocusableTip ft, String msg) {
		...
		cp.setBorder(jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.TipUtil.getToolTipBorder());
		cp.setBackground(jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.TipUtil.getToolTipBackground());
		textArea = new JEditorPane("text/html", text);
		jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.TipUtil.tweakTipEditorPane(textArea);
	...
	private void setBottomPanel() {
		...
		if (focusable) {
			jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.SizeGrip sg = new jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.focusabletip.SizeGrip();
