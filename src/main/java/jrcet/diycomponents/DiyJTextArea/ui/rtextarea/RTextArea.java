...
import jrcet.diycomponents.DiyJTextArea.print.RPrintUtilities;
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.DocumentRange;
import jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro.MacroRecord;
 ...
 * @version 1.0
 */
public class RTextArea extends jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextAreaBase implements Printable {

	/**
	 * Constant representing insert mode.
	 *
	 * @see #setCaretStyle(int, jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle)
	 */
	...
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro currentMacro;
	 ...
	 */
	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ToolTipSupplier toolTipSupplier;

	protected static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction cutAction;
	protected static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction copyAction;
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction pasteAction;
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction deleteAction;
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction undoAction;
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction redoAction;
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction selectAllAction;

	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.IconGroup iconGroup;		// Info on icons for actions.

	private transient RUndoManager undoManager;

	private transient jrcet.diycomponents.DiyJTextArea.ui.rtextarea.LineHighlightManager lineHighlightManager;

	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.SmartHighlightPainter markAllHighlightPainter;

	private boolean markAllOnOccurrenceSearches;

	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle[] carets;	// Index 0=>insert caret, 1=>overwrite.

	private static final String MSG	= "jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea";
	...
	static synchronized void addToCurrentMacro(String id,
		...
		currentMacro.addMacroRecord(new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro.MacroRecord(id, actionCommand));
	}
	...
	public Object addLineHighlight(int line, Color color)
		...
		if (lineHighlightManager==null) {
			lineHighlightManager = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.LineHighlightManager(this);
		}
	...
	public static synchronized void beginRecordingMacro() {
		...
		currentMacro = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro();
		recordingMacro = true;
	}
	...
	protected Document createDefaultModel() {
		return new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RDocument();
	}
	 ...
	 *         requested.
	 */
	public static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction getAction(int action) {
	 ...
	 *         recorded/loaded.
	 * @see #loadMacro(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro)
	 */
	public static synchronized jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Macro getCurrentMacro() {
		return currentMacro;
	}
	 ...
	 * @see #setIconGroup(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.IconGroup)
	 */
	public static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.IconGroup getIconGroup() {
		return iconGroup;
	}
	 ...
	 */
	jrcet.diycomponents.DiyJTextArea.ui.rtextarea.LineHighlightManager getLineHighlightManager() {
	 ...
	 *         installed.
	 * @see #setToolTipSupplier(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ToolTipSupplier)
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ToolTipSupplier getToolTipSupplier() {
	 ...
	 * {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ToolTipSupplier}; if there is one installed, it is queried for
	...
	protected void init() {
		...
		carets = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle[2];
		setCaretStyle(INSERT_MODE, jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle.THICK_VERTICAL_LINE_STYLE);
		setCaretStyle(OVERWRITE_MODE, jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle.BLOCK_STYLE);
	 ...
	 * this method is called indirectly from {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.SearchEngine} when doing
				...
				try {
					for (MacroRecord record : macroRecords) {
						for (Action action : actions) {
							if ((action instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RecordableTextAction) &&
								record.id.equals(
	 ...
	 * use {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret}s (which is used by default), or a
	...
	public void setCaret(Caret caret) {
		...
		if (carets!=null && // Called by setUI() before carets is initialized
				caret instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret) {
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret)caret).setStyle(carets[getTextMode()]);
		}
	}
	 ...
	 * @see jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret
	 */
	public void setCaretStyle(int mode, jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle style) {
		if (style==null) {
			style = CaretStyle.THICK_VERTICAL_LINE_STYLE;
		}
		carets[mode] = style;
		if (mode==getTextMode() && getCaret() instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret) {
			// Will repaint the caret if necessary.
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret)getCaret()).setStyle(style);
		}
	}
	 ...
	 *         {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RDocument}.
	 */
	@Override
	 ...
	 * caret is an instance of {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret}, it will be
	...
	public void setTextMode(int mode) {
		...
		if (textMode != mode) {
			Caret caret = getCaret();
			if (caret instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret) {
