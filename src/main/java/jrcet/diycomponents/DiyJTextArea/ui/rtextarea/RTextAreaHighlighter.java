...
/**
 * The highlighter implementation used by {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea}s.  It knows to
...
public class RTextAreaHighlighter extends BasicHighlighter {
	 ...
	 */
	protected jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea;
	...
	protected static class LayeredHighlightInfoImpl extends HighlightInfoImpl
		...
		public void paintLayeredHighlights(Graphics g, int p0, int p1,
			...
			p1 = Math.min(end, p1);
			if (getColor()!=null &&
					getPainter() instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ChangeableHighlightPainter) {
