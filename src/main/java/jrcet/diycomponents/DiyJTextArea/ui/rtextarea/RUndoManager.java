...
public class RUndoManager extends UndoManager {
	...
	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea;
	 ...
	 */
	public RUndoManager(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea) {
	...
	public void updateActions() {
		...
		Action a = jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea.getAction(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea.UNDO_ACTION);
		if (canUndo()) {
			a.setEnabled(true);
		...
		a = jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea.getAction(RTextArea.REDO_ACTION);
		if (canRedo()) {
			a.setEnabled(true);
