...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.ActiveLineRangeEvent;
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.ActiveLineRangeListener;
...
public class Gutter extends JPanel {
	...
	private class TextAreaListener extends ComponentAdapter
		...
		protected void handleDocumentEvent(DocumentEvent e) {
			for (int i=0; i<getComponentCount(); i++) {
				jrcet.diycomponents.DiyJTextArea.ui.rtextarea.AbstractGutterComponent agc =
							(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.AbstractGutterComponent)getComponent(i);
