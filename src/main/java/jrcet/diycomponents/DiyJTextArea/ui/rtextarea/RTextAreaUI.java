...
public class RTextAreaUI extends BasicTextAreaUI {
	...
	protected jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea;				// The text area for which we are the UI.

	private static final EditorKit DEFAULT_KIT = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextAreaEditorKit();
	...
	public RTextAreaUI(JComponent textArea) {
		if (!(textArea instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea)) {
			throw new IllegalArgumentException("RTextAreaUI is for " +
							 		"instances of RTextArea only!");
		}
		this.textArea = (jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea)textArea;
	}
	...
	private void correctNimbusDefaultProblems(JTextComponent editor) {
		...
		if (c==null) {
			editor.setCaretColor(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea.getDefaultCaretColor());
		}
	 ...
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea getRTextArea() {
		return textArea;
	}
	...
	protected void installKeyboardActions() {
		...
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea = getRTextArea();
	...
	protected void paintLineHighlights(Graphics g) {
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.LineHighlightManager lhm = textArea.getLineHighlightManager();
		if (lhm!=null) {
