...
//	}
	...
	public final Object getBackgroundObject() {
		...
		return (backgroundPainter instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ImageBackgroundPainterStrategy) ?
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ImageBackgroundPainterStrategy)backgroundPainter).getMasterImage() :
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ColorBackgroundPainterStrategy)backgroundPainter).getColor();
	}
...
try {
	...
	public void setBackground(Color bg) {
		...
		if (oldBG instanceof Color) { // Just change color of strategy.
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ColorBackgroundPainterStrategy)backgroundPainter).
						setColor(bg);
		}
	...
	public void setBackgroundImage(Image image) {
		...
		if (oldBG instanceof Image) { // Just change image being displayed.
			((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ImageBackgroundPainterStrategy)backgroundPainter).
					setImage(image);
		}
...
//	}
	...
	public void setRoundedSelectionEdges(boolean rounded) {
		if (roundedSelectionEdges!=rounded) {
			...
			Caret c = getCaret();
			if (c instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ConfigurableCaret) {
