...
import jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.FoldingAwareIconRowHeader;
...
/**
 * Renders icons in the {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter}.  This can be used to visually mark
 ...
 * feature.  This is actually done on the parent {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter} component:<p>
 *
 * <pre>
 ...
 */
public class IconRowHeader extends jrcet.diycomponents.DiyJTextArea.ui.rtextarea.AbstractGutterComponent implements MouseListener {
	 ...
	 *         into the text area.
	 * @see #removeTrackingIcon(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo)
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo addOffsetTrackingIcon(int offs, Icon icon)
	 ...
	 * @see #removeTrackingIcon(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo)
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo addOffsetTrackingIcon(int offs, Icon icon, String tip)
												throws BadLocationException {
	 ...
	 *         returned.
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[] getBookmarks() {

		List<jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo> retVal = new ArrayList<>(1);
		...
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[] array = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[retVal.size()];
	...
	public String getToolTipText(MouseEvent e) {
		try {
			...
			if (line>-1) {
				jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[] infos = getTrackingIcons(line);
				if (infos.length>0) {
	 ...
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[] getTrackingIcons(int line)
								throws BadLocationException {
	...
	protected void paintComponent(Graphics g) {
		...
		if (trackingIcons!=null) {
			...
			for (int i=trackingIcons.size()-1; i>=0; i--) { // Last to first
				jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo ti = getTrackingIcon(i);
				int offs = ti.getMarkedOffset();
...
//			int lineEndY = r.y+r.height;
	 ...
	 */
	public void removeTrackingIcon(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo tag) {
	 ...
	 * @see jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter#DEFAULT_ACTIVE_LINE_RANGE_COLOR
	 */
	...
	public boolean toggleBookmark(int line) throws BadLocationException {
		...
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo[] icons = getTrackingIcons(line);
		if (icons.length==0) {
		...
		boolean found = false;
		for (jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo icon : icons) {
	 ...
	 */
	private static class GutterIconImpl implements jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo,
			Comparable<jrcet.diycomponents.DiyJTextArea.ui.rtextarea.GutterIconInfo> {
