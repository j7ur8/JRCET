 ...
 *       {@link #setStyle(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle)} method and {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle} for
 *       more information.</li>
...
public class ConfigurableCaret extends DefaultCaret {
	 ...
	 */
	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle style;

	/**
	 * The selection painter.  By default this paints selections with the
	 * text area's selection color.
	 */
	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ChangeableHighlightPainter selectionPainter;
	...
	/**
	 * Creates the caret using {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle#THICK_VERTICAL_LINE_STYLE}.
	 */
	public ConfigurableCaret() {
		this(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle.THICK_VERTICAL_LINE_STYLE);
	}
	 ...
	 *        invalid, then {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle#THICK_VERTICAL_LINE_STYLE} is
	 *        used.
	 */
	public ConfigurableCaret(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle style) {
		seg = new Segment();
		setStyle(style);
		selectionPainter = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ChangeableHighlightPainter();
	...
	public boolean getRoundedSelectionEdges() {
		return ((jrcet.diycomponents.DiyJTextArea.ui.rtextarea.ChangeableHighlightPainter)getSelectionPainter()).
								getRoundedEdges();
	}
	 ...
	 * @see #setStyle(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle)
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle getStyle() {
		return style;
	}
	 ...
	 * @see #getStyle()
	 */
	public void setStyle(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.CaretStyle style) {
		if (style==null) {
	...
	private void validateWidth(Rectangle rect) {
		...
		if (rect!=null && rect.width<=1) {
			...
			// a "smart" view like jrcet.diycomponents.DiyJTextArea.ui.rsyntaxtextarea.SyntaxView,
