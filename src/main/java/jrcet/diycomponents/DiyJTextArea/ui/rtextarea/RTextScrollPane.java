 ...
 * </ul>
 *
 * The actual "meat" of these extras is contained in the {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter} class.
...
public class RTextScrollPane extends JScrollPane {
	...
	private jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter gutter;


	/**
	 * Constructor.  If you use this constructor, you must call
	 * {@link #setViewportView(Component)} and pass in an {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea}
	 ...
	 */
	public RTextScrollPane(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea) {
		this(textArea, true);
	}
	 ...
	 *        be an instance of {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea},
	 ...
	 *        {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea}.
	 * @param lineNumbers Whether line numbers should be enabled.
	 */
	public RTextScrollPane(jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea, boolean lineNumbers) {
	...
	public RTextScrollPane(Component comp, boolean lineNumbers,
		...
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea textArea = getFirstRTextAreaDescendant(comp);

		// Create the gutter for this document.
		Font defaultFont = new Font(Font.MONOSPACED, Font.PLAIN, 12);
		gutter = new jrcet.diycomponents.DiyJTextArea.ui.rtextarea.Gutter(textArea);
	 ...
	 */
	public jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea getTextArea() {
		return (jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea)getViewport().getView();
	}
	...
	/**
	 * Sets the view for this scroll pane.  This must be an {@link jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea}.
	 *
	...
	public void setViewportView(Component view) {
		...
		jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea rtaCandidate = null;

		if (!(view instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea)) {
			...
			rtaCandidate = (jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea)view;
		}
	 ...
	 *         is found.
	 */
	private static jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea getFirstRTextAreaDescendant(Component comp) {
		Stack<Component> stack = new Stack<>();
		stack.add(comp);
		while (!stack.isEmpty()) {
			Component current = stack.pop();
			if (current instanceof jrcet.diycomponents.DiyJTextArea.ui.rtextarea.RTextArea) {
